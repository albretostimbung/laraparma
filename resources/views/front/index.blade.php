@extends('layouts.front', ['title' => 'Landing Page'])
        ...
        <div id="categoriesSlider" class="relative">
            @forelse ($categories as $category)
                <div class="inline-flex gap-2.5 items-center py-3 px-3.5 relative bg-white rounded-xl mr-4">
                    <img src="{{ asset('storage/' . $category->icon) }}" class="size-10" alt="">
        ...
        <div id="proudctsSlider" class="relative">
            @forelse ($products as $product)
                <div
                    ...
                    <img src="{{ asset('storage/' . $product->photo) }}" class="h-[100px] w-full object-contain"
                        alt="">
                    <div>
