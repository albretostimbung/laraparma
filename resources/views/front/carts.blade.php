@extends('layouts.front', ['title' => 'Carts'])
...
@section('content')
                ...
                <div class="py-3.5 pl-4 pr-[22px] bg-white rounded-2xl flex gap-1 items-center relative">
                    ...
                    <div class="flex flex-wrap items-center justify-between w-full gap-1">
                        <div class="flex flex-col gap-1">
                            ...
                            <p class="text-sm text-grey product-price" data-price="{{ $item->product->price }}">
    ...
    <section class="wrapper flex flex-col gap-2.5 pb-40">
        ...
        <form action="{{ route('product-transactions.store') }}" method="POST" enctype="multipart/form-data"
...
@push('append-scripts')
    ...
    <script>
        function calculatePrice() {
            ...
            const taxPPN = 11 * subTotal / 100;

            document.getElementById('checkout-ppn').textContent = 'Rp ' + taxPPN.toLocaleString('id', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
            });
            ...
            const grandTotalPrice = subTotal + taxPPN + insurance + deliveryFee;
