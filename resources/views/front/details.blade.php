@extends('layouts.front', ['title' => 'Details'])

@section('content')
    <!-- Topbar -->
    <section class="relative flex items-center justify-between gap-5 wrapper">
        <a href="javascript:void(0)" onclick="history.back()" class="p-2 bg-white rounded-full">
    ...
    <img src="{{ asset('storage/' . $product->photo) }}" class="h-[220px] w-auto mx-auto relative z-10" alt="">
            ...
            <div class="flex items-center justify-between">
                <div class="flex flex-col gap-1">
                    ...
                    <div class="flex items-center gap-1.5">
                        <img src="{{ asset('storage/' . $product->category->icon) }}" class="size-[30px]" alt="">
